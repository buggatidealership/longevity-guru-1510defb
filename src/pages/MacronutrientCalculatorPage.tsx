...
const MacronutrientCalculatorPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Macronutrient Calculator | Plan Your Ideal Diet Composition"
        description="Calculate your ideal macronutrient ratios with our free calculator. Get personalized protein, carb, and fat targets based on your goals and body type."
        canonicalUrl="https://longevitycalculator.xyz/macronutrient-calculator"
        keywords="macronutrient calculator, macro calculator, protein calculator, carb calculator, fat calculator, iifym calculator, flexible dieting"
        ogType="website"
        ogImage="https://longevitycalculator.xyz/longevity-calculator-og.png"
      />
      <CanonicalFixer expectedCanonicalUrl="https://longevitycalculator.xyz/macronutrient-calculator" />
