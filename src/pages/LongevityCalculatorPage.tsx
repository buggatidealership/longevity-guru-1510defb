        ...
        <footer className="max-w-6xl mx-auto px-4 py-8">
          <div className="border-t pt-8">
            ...
            <div className="flex justify-center space-x-4 mt-4 text-xs text-gray-500">
              <a href="https://longevitycalculator.xyz/privacy" className="hover:text-gray-700">Privacy Policy</a>
              <a href="https://longevitycalculator.xyz/terms" className="hover:text-gray-700">Terms of Use</a>
              <a href="https://longevitycalculator.xyz/sitemap.xml" className="hover:text-gray-700">Sitemap</a>
            </div>
          </div>
        </footer>
      </div>
