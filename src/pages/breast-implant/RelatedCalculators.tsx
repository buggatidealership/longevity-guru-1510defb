...
const RelatedCalculators: React.FC<RelatedCalculatorsProps> = ({ handleLinkClick }) => {
  return (
    <div className="mt-8 mb-6 p-4 bg-white rounded-xl shadow-sm">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
        ...
        <Link to="/growth-percentile-calculator" onClick={handleLinkClick} className="border rounded-lg p-3 hover:shadow-md transition-shadow">
