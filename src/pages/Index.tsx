...
import { Clock, Calculator, ArrowRight, Baby, Ruler, LineChart, Activity, Scissors, Syringe } from 'lucide-react';

const Index = () => {
  // Count the number of calculator pages (excluding placeholder/coming soon calculators)
  const calculatorCount = 8; // Current count: lifespan, retirement, fertility, growth, adult height, metabolism, breast implant, botox
