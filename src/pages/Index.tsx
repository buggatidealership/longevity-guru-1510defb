...
import { Clock, Calculator, ArrowRight, Baby, Ruler, LineChart, Activity, Scissors, Syringe, Beer } from 'lucide-react';

const Index = () => {
  // Count the number of calculator pages (excluding placeholder/coming soon calculators)
  const calculatorCount = 9; // Current count: lifespan, retirement, fertility, growth, adult height, metabolism, breast implant, botox, alcohol
  ...
  return (
    <>
      <SEOHead 
        ...
        keywords="free calculators, health calculators, financial planning tools, life expectancy, retirement calculator, fertility calculator, growth percentile, adult height predictor, metabolism calculator, breast implant calculator, botox calculator, alcohol calculator"
        ogType="website"
