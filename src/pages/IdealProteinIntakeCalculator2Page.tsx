...
const IdealProteinIntakeCalculator2Page: React.FC = () => {
  ...
  const schemas = [
    generateWebPageSchema(
      ...
      "ideal-protein-intake-calculator-2"
    ),
    generateBreadcrumbSchema([
      { name: 'Home', path: '/' },
      { name: 'Calculators', path: '/' },
      { name: 'Ideal Protein Intake Calculator', path: '/ideal-protein-intake-calculator-2' }
    ]),
    {
...
export default IdealProteinIntakeCalculator2Page;
