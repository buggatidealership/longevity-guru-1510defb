  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="mb-3"><strong>Age:</strong> Pattern hair loss is progressive and age-dependent, with risk increasing over time.</p>
        <p className="mb-3"><strong>Biological sex:</strong> Men and women experience different patterns and probabilities of hair loss.</p>
        <p className="mb-3"><strong>Family history:</strong> The presence and severity of baldness in your immediate family, particularly parents and grandparents.</p>
        <p className="mb-3"><strong>Current hair status:</strong> Early signs of thinning, recession, or miniaturization are strong predictors of future progression.</p>
        <p className="mb-3"><strong>Hair loss pattern:</strong> The specific pattern of your hair loss provides clues about its likely trajectory.</p>
      ...
      <section>
        ...
        <p className="mb-2"><strong>Stage 1:</strong> Little to no visible recession; baseline mature hairline</p>
        <p className="mb-2"><strong>Stage 2:</strong> Slight recession at the temples, creating an "M" shape</p>
        <p className="mb-2"><strong>Stage 3:</strong> Deeper temple recession and/or thinning at the crown</p>
        <p className="mb-2"><strong>Stage 4:</strong> More severe recession and crown thinning, with solid hair between</p>
        <p className="mb-2"><strong>Stage 5:</strong> Larger balding areas with a narrower band of hair separating them</p>
        <p className="mb-2"><strong>Stage 6:</strong> Temple and crown balding areas connect, with significant hair loss</p>
        <p className="mb-4"><strong>Stage 7:</strong> Only a horseshoe pattern of hair remains around the sides and back</p>
        
        <h3 className="text-xl font-medium mt-4 mb-2">Female Pattern Hair Loss (Ludwig Scale)</h3>
        
        <p className="mb-2"><strong>Grade 1:</strong> Minimal thinning at the part line, often only noticeable to the individual</p>
        <p className="mb-2"><strong>Grade 2:</strong> Increased thinning and widening of the part, with moderate reduction in hair volume</p>
        <p className="mb-4"><strong>Grade 3:</strong> Significant diffuse thinning across the crown, often with visible scalp</p>
