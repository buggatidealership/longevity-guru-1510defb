...
const HowToBoostYourMetabolism = () => {
  ...
  return (
    <>
      <SEOHead 
        title="How to Boost Your Metabolism Naturally (Backed by Science)"
        description="Learn science-backed ways to naturally boost your metabolism. Discover which habits truly help and how much your body burns daily."
        canonicalUrl="/resources/how-to-boost-your-metabolism"
        keywords="boost metabolism, increase metabolic rate, metabolism calculator, burn more calories, speed up metabolism, natural metabolism boosters"
        schemas={schemas}
      />
        ...
        <main className="max-w-4xl mx-auto px-4 py-6">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>How to Boost Your Metabolism</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          
          <article className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How to Boost Your Metabolism Naturally: 5 Science-Backed Methods</h1>
...
export default HowToBoostYourMetabolism;
