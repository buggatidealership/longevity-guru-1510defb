...
const FertilityAfter35 = () => {
  // Generate schema for breadcrumbs
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Home', path: '/' },
    { name: 'Resources', path: '/resources' },
    { name: 'Fertility After 35', path: '/resources/fertility-after-35' }
  ]);

  // Generate article schema
  const articleSchema = generateArticleSchema(
    "Fertility After 35: Facts, Fears, and Your Chances of Conceiving",
    "Learn about fertility decline after 35, egg quality, ovarian reserve, and how to improve your chances of conceiving. A science-backed guide with practical tools.",
    "/resources/fertility-after-35",
    "2025-03-23T08:00:00+00:00",
    "2025-03-23T10:30:00+00:00",
  ...
  return (
    <>
      <SEOHead 
        title="Fertility After 35: Facts, Fears, and Your Chances of Conceiving"
        description="Understand fertility decline after 35, egg quality, ovarian reserve, and how to improve your chances of conceiving. A science-backed guide with practical tools."
        canonicalUrl="/resources/fertility-after-35"
        keywords="fertility after 35, advanced maternal age, egg quality, ovarian reserve, fertility decline, conception chances, fertility tests, female fertility"
        schemas={schemas}
      />
        ...
        <main className="max-w-4xl mx-auto px-4 py-6">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Fertility After 35</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          
          <article className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Fertility After 35: Facts, Fears, and Your Chances of Conceiving</h1>
...
export default FertilityAfter35;
