...
const LongevityCalculator = () => {
  ...
  useEffect(() => {
    ...
    age, sex, race, exerciseLevel, sleepHours, smoking, alcohol, diet, 
  ...
  const Select = ({ id, value, onChange, options }: { 
    ...
    <select 
      ...
      value={value} 
      onChange={onChange}
      className="w-full p-3 border border-gray-200 rounded-xl bg-white bg-opacity-50 backdrop-blur-xs shadow-sm input-focus-ring"
    >
      {options.map(option => (
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-12 space-y-8">
      <div className="text-center space-y-2 max-w-2xl mx-auto">
        <h1 className="text-3xl font-display font-bold tracking-tight">Longevity Calculator</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      step="0.1"
                      value={bmi}
                      onChange={(e) => setBmi(parseFloat(e.target.value || "24"))}
                      className="w-full p-3 border border-gray-200 rounded-xl bg-white bg-opacity-50 backdrop-blur-xs shadow-sm input-focus-ring"
                    />
                  ...
                  <div>
                    <label className="flex items-center space-x-2 cursor-pointer">
                      <input
                        ...
                        className="rounded border-gray-300 text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 focus:ring-opacity-50 focus:ring-offset-0"
                      />
                  ...
                  <div>
                    ...
                    <Select 
                      ...
                      options={[
                        ...
                        { value: 'preventive', label: 'Preventive/Comprehensive' }
                      ]}
                    />
                  </div>
                      ...
                      {[
                        ...
                        <label key={condition.id} className="flex items-center cursor-pointer">
                          <input
                            ...
                            onChange={() => handleChronicConditionChange(condition.id)}
                            className="rounded border-gray-300 text-primary shadow-sm focus:border-primary focus:ring focus:ring-primary/20 focus:ring-opacity-50 focus:ring-offset-0"
                          />
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select 
                      ...
                      onChange={(e) => setSocialConnections(e.target.value)}
                      options={[
        ...
        <div>
          <div className="sticky top-8 space-y-6">
            <ResultCard 
              years={result.years}
              baseAge={result.baseAge}
              improvement={result.improvement}
              improvementPercentage={result.improvementPercentage}
            />
            
            <div className="bg-white bg-opacity-70 backdrop-blur-sm rounded-xl border border-gray-100 p-4 text-sm text-muted-foreground animate-fadeIn" style={{ animationDelay: '0.3s' }}>
